...
const RingingAnimation: React.FC = () => {
  return (
    <div className="relative flex items-center justify-center w-24 h-24">
      <div className="absolute w-full h-full bg-blue-500 rounded-full opacity-50 animate-ping"></div>
      <div
        className="absolute w-3/4 h-3/4 bg-blue-400 rounded-full opacity-50 animate-ping"
        style={{ animationDelay: "0.5s" }}
      ></div>
      <div
        className="absolute w-1/2 h-1/2 bg-blue-300 rounded-full opacity-50 animate-ping"
